...
function(citron_configure_pgo target_name)
    ...
    # MSVC-specific PGO (This section is unchanged from your original file)
    if(MSVC)
    ...
    # GCC-specific PGO (FIXED: Uses robust -fprofile-dir flag)
    ...
    # Clang-specific PGO (FIXED: Uses correct flags and assumes CWD for output)
